...
static char *help_str =
  ...
  "       \n"
  "     tables               Character string, \"tables\" used as option flag to fetch table number list and table sizes for one or more material IDs\n"
  "       \n"
  "     comments             Character string, \"comments\" used as option flag to fetch all comments for one or more material IDs\n"
  "       \n"
  "     <GENERAL OPTIONS>\n"
  "     -F <file>\n"
