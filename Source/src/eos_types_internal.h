...
eos_TableData _eos_TableList[] = {
  ...
  /*   7 */ {EOS_Pt_DAt,    "EOS_Pt_DAt",    301,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Pt,        EOS_D,         EOS_At,        EOS_NullTable,  EOS_NullTable,  EOS_Pt_DT,        EOS_T_DAt,        EOS_FALSE, "Total Pressure (GPa) (Density (Mg/m^3)- and Total Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /*  12 */ {EOS_Ut_DAt,    "EOS_Ut_DAt",    301,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Ut,        EOS_D,         EOS_At,        EOS_NullTable,  EOS_NullTable,  EOS_Ut_DT,        EOS_T_DAt,        EOS_FALSE, "Total Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /*  15 */ {EOS_At_DT,     "EOS_At_DT",     301,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_TOTAL,         EOS_At,        EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Total Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /*  16 */ {EOS_T_DAt,     "EOS_T_DAt",     301,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_TOTAL,         EOS_T,         EOS_D,         EOS_At,        EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Total Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /*  17 */ {EOS_At_DPt,    "EOS_At_DPt",    301,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_At,        EOS_D,         EOS_Pt,        EOS_NullTable,  EOS_NullTable,  EOS_At_DT,        EOS_T_DPt,        EOS_FALSE, "Total Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Pressure (GPa)-dependent)"},
  /*  18 */ {EOS_At_DUt,    "EOS_At_DUt",    301,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_At,        EOS_D,         EOS_Ut,        EOS_NullTable,  EOS_NullTable,  EOS_At_DT,        EOS_T_DUt,        EOS_FALSE, "Total Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Internal-Energy (MJ/kg)-dependent)"},
  /*  19 */ {EOS_At_DSt,    "EOS_At_DSt",    301,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_At,        EOS_D,         EOS_St,        EOS_NullTable,  EOS_NullTable,  EOS_At_DT,        EOS_T_DSt,        EOS_FALSE, "Total Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Entropy (MJ/kg/K)-dependent)"},
  ...
  /*  24 */ {EOS_St_DAt,    "EOS_St_DAt",    301,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_St,        EOS_D,         EOS_At,        EOS_NullTable,  EOS_NullTable,  EOS_St_DT,        EOS_T_DAt,        EOS_FALSE, "Total Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Total Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /*  35 */ {EOS_Aic_DT,    "EOS_Aic_DT",    303,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_ION_PLUS_COLD, EOS_Aic,       EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /*  36 */ {EOS_T_DAic,    "EOS_T_DAic",    303,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_ION_PLUS_COLD, EOS_T,         EOS_D,         EOS_Aic,       EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /*  37 */ {EOS_Aic_DPic,  "EOS_Aic_DPic",  303,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Aic,       EOS_D,         EOS_Pic,       EOS_NullTable,  EOS_NullTable,  EOS_Aic_DT,       EOS_T_DPic,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Pressure plus Cold Curve Pressure (GPa)-dependent)"},
  /*  38 */ {EOS_Aic_DUic,  "EOS_Aic_DUic",  303,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Aic,       EOS_D,         EOS_Uic,       EOS_NullTable,  EOS_NullTable,  EOS_Aic_DT,       EOS_T_DUic,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Internal-Energy plus Cold Curve Specific-Internal-Energy (MJ/kg)-dependent)"},
  /*  39 */ {EOS_Aic_DSic,  "EOS_Aic_DSic",  303,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Aic,       EOS_D,         EOS_Sic,       EOS_NullTable,  EOS_NullTable,  EOS_Aic_DT,       EOS_T_DSic,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Pressure plus Cold Curve Specific-Entropy (MJ/kg/K)-dependent)"},
  ...
  /*  48 */ {EOS_Pe_DAe,    "EOS_Pe_DAe",    304,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Pe,        EOS_D,         EOS_Ae,        EOS_NullTable,  EOS_NullTable,  EOS_Pe_DT,        EOS_T_DAe,        EOS_FALSE, "Electron Pressure (GPa) (Density (Mg/m^3)- and Electron Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /*  53 */ {EOS_Ue_DAe,    "EOS_Ue_DAe",    304,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ue,        EOS_D,         EOS_Ae,        EOS_NullTable,  EOS_NullTable,  EOS_Ue_DT,        EOS_T_DAe,        EOS_FALSE, "Electron Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /*  55 */ {EOS_Ae_DT,     "EOS_Ae_DT",     304,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_ELECTRON,      EOS_Ae,        EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Electron Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /*  56 */ {EOS_T_DAe,     "EOS_T_DAe",     304,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_ELECTRON,      EOS_T,         EOS_D,         EOS_Ae,        EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Electron Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /*  57 */ {EOS_Ae_DPe,    "EOS_Ae_DPe",    304,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ae,        EOS_D,         EOS_Pe,        EOS_NullTable,  EOS_NullTable,  EOS_Ae_DT,        EOS_T_DPe,        EOS_FALSE, "Electron Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Pressure (GPa)-dependent)"},
  /*  58 */ {EOS_Ae_DUe,    "EOS_Ae_DUe",    304,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ae,        EOS_D,         EOS_Ue,        EOS_NullTable,  EOS_NullTable,  EOS_Ae_DT,        EOS_T_DUe,        EOS_FALSE, "Electron Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Internal-Energy (MJ/kg)-dependent)"},
  /*  59 */ {EOS_Ae_DSe,    "EOS_Ae_DSe",    304,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ae,        EOS_D,         EOS_Se,        EOS_NullTable,  EOS_NullTable,  EOS_Ae_DT,        EOS_T_DSe,        EOS_FALSE, "Electron Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Entropy (MJ/kg/K)-dependent)"},
  ...
  /*  64 */ {EOS_Se_DAe,    "EOS_Se_DAe",    304,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Se,        EOS_D,         EOS_Ae,        EOS_NullTable,  EOS_NullTable,  EOS_Se_DT,        EOS_T_DAe,        EOS_FALSE, "Electron Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Electron Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /*  68 */ {EOS_Piz_DAiz,  "EOS_Piz_DAiz",  305,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Piz,       EOS_D,         EOS_Aiz,       EOS_NullTable,  EOS_NullTable,  EOS_Piz_DT,       EOS_T_DAiz,       EOS_FALSE, "Ion Pressure Including Zero Point (GPa) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  ...
  /*  73 */ {EOS_Uiz_DAiz,  "EOS_Uiz_DAiz",  305,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Uiz,       EOS_D,         EOS_Aiz,       EOS_NullTable,  EOS_NullTable,  EOS_Uiz_DT,       EOS_T_DAiz,       EOS_FALSE, "Ion Specific-Internal-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  ...
  /*  75 */ {EOS_Aiz_DT,    "EOS_Aiz_DT",    305,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_ION,           EOS_Aiz,       EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /*  76 */ {EOS_T_DAiz,    "EOS_T_DAiz",    305,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_ION,           EOS_T,         EOS_D,         EOS_Aiz,       EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  /*  77 */ {EOS_Aiz_DPiz,  "EOS_Aiz_DPiz",  305,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Aiz,       EOS_D,         EOS_Piz,       EOS_NullTable,  EOS_NullTable,  EOS_Aiz_DT,       EOS_T_DPiz,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Pressure Including Zero Point (GPa)-dependent)"},
  /*  78 */ {EOS_Aiz_DUiz,  "EOS_Aiz_DUiz",  305,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Aiz,       EOS_D,         EOS_Uiz,       EOS_NullTable,  EOS_NullTable,  EOS_Aiz_DT,       EOS_T_DUiz,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Internal-Energy Including Zero Point (MJ/kg)-dependent)"},
  /*  79 */ {EOS_Aiz_DSiz,  "EOS_Aiz_DSiz",  305,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Aiz,       EOS_D,         EOS_Siz,       EOS_NullTable,  EOS_NullTable,  EOS_Aiz_DT,       EOS_T_DSiz,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Pressure Including Zero Specific-Entropy (MJ/kg/K)-dependent)"},
  ...
  /*  84 */ {EOS_Siz_DAiz,  "EOS_Siz_DAiz",  305,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Siz,       EOS_D,         EOS_Aiz,       EOS_NullTable,  EOS_NullTable,  EOS_Siz_DT,       EOS_T_DAiz,       EOS_FALSE, "Ion Pressure Including Zero Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  ...
  /*  87 */ {EOS_Ac_D,      "EOS_Ac_D",      306,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_COLD,          EOS_Ac,        EOS_D,         EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Specific-Helmholtz-Free-Energy Cold Curve (MJ/kg) (Density (Mg/m^3)-dependent)"},
  ...
  /*  94 */ {EOS_Pv_Av,     "EOS_Pv_Av",     401,      1,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Pv,        EOS_Av,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Pv_T,         EOS_T_Av,         EOS_FALSE, "Vapor Pressure (GPa) (Vapor Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /*  95 */ {EOS_Pv_Als,    "EOS_Pv_Als",    401,      1,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Pv,        EOS_Als,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Pv_T,         EOS_T_Als,        EOS_FALSE, "Vapor Pressure (GPa) (Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 102 */ {EOS_Dv_Av,     "EOS_Dv_Av",     401,      2,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Dv,        EOS_Av,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Dv_T,         EOS_T_Av,         EOS_FALSE, "Vapor Density on coexistence line (Mg/m^3) (Vapor Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 103 */ {EOS_Dv_Als,    "EOS_Dv_Als",    401,      2,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Dv,        EOS_Als,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Dv_T,         EOS_T_Als,        EOS_FALSE, "Vapor Density on coexistence line (Mg/m^3) (Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 110 */ {EOS_Dls_Av,    "EOS_Dls_Av",    401,      3,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Dls,       EOS_Av,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Dls_T,        EOS_T_Av,         EOS_FALSE, "Liquid or Solid Density on coexistence line (Mg/m^3) (Vapor Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 111 */ {EOS_Dls_Als,   "EOS_Dls_Als",   401,      3,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Dls,       EOS_Als,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Dls_T,        EOS_T_Als,        EOS_FALSE, "Liquid or Solid Density on coexistence line (Mg/m^3) (Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 118 */ {EOS_Uv_Av,     "EOS_Uv_Av",     401,      4,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Uv,        EOS_Av,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Uv_T,         EOS_T_Av,         EOS_FALSE, "Vapor Specific-Internal-Energy (MJ/kg) (Vapor Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 119 */ {EOS_Uv_Als,    "EOS_Uv_Als",    401,      4,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Uv,        EOS_Als,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Uv_T,         EOS_T_Als,        EOS_FALSE, "Vapor Specific-Internal-Energy (MJ/kg) (Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 126 */ {EOS_Uls_Av,    "EOS_Uls_Av",    401,      5,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Uls,       EOS_Av,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Uls_T,        EOS_T_Av,         EOS_FALSE, "Liquid or Solid Specific-Internal-Energy (MJ/kg) (Vapor Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 127 */ {EOS_Uls_Als,   "EOS_Uls_Als",   401,      5,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Uls,       EOS_Als,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Uls_T,        EOS_T_Als,        EOS_FALSE, "Liquid or Solid Specific-Internal-Energy (MJ/kg) (Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 128 */ {EOS_Av_T,      "EOS_Av_T",      401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY0, EOS_VAPORIZATION,  EOS_Av,        EOS_T,         EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Vapor Specific-Helmholtz-Free-Energy (MJ/kg) (Temperature (K)-dependent)"},
  /* 129 */ {EOS_T_Av,      "EOS_T_Av",      401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY1, EOS_VAPORIZATION,  EOS_T,         EOS_Av,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Vapor Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 130 */ {EOS_Av_Pv,     "EOS_Av_Pv",     401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Av,        EOS_Pv,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Av_T,         EOS_T_Pv,         EOS_FALSE, "Vapor Specific-Helmholtz-Free-Energy (MJ/kg) (Vapor Pressure (GPa)-dependent)"},
  /* 131 */ {EOS_Av_Dv,     "EOS_Av_Dv",     401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Av,        EOS_Dv,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Av_T,         EOS_T_Dv,         EOS_FALSE, "Vapor Specific-Helmholtz-Free-Energy (MJ/kg) (Vapor Density on coexistence line (Mg/m^3)-dependent)"},
  /* 132 */ {EOS_Av_Dls,    "EOS_Av_Dls",    401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Av,        EOS_Dls,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Av_T,         EOS_T_Dls,        EOS_FALSE, "Vapor Specific-Helmholtz-Free-Energy (MJ/kg) (Liquid or Solid Density on coexistence line (Mg/m^3)-dependent)"},
  /* 133 */ {EOS_Av_Uv,     "EOS_Av_Uv",     401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Av,        EOS_Uv,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Av_T,         EOS_T_Uv,         EOS_FALSE, "Vapor Specific-Helmholtz-Free-Energy (MJ/kg) (Vapor Specific-Internal-Energy (MJ/kg)-dependent)"},
  /* 134 */ {EOS_Av_Uls,    "EOS_Av_Uls",    401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Av,        EOS_Uls,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Av_T,         EOS_T_Uls,        EOS_FALSE, "Vapor Specific-Helmholtz-Free-Energy (MJ/kg) (Liquid or Solid Specific-Internal-Energy (MJ/kg)-dependent)"},
  /* 135 */ {EOS_Av_Als,    "EOS_Av_Als",    401,      6,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Av,        EOS_Als,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Av_T,         EOS_T_Als,        EOS_FALSE, "Vapor Specific-Helmholtz-Free-Energy (MJ/kg) (Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 136 */ {EOS_Als_T,     "EOS_Als_T",     401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY0, EOS_VAPORIZATION,  EOS_Als,       EOS_T,         EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg) (Temperature (K)-dependent)"},
  /* 137 */ {EOS_T_Als,     "EOS_T_Als",     401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY1, EOS_VAPORIZATION,  EOS_T,         EOS_Als,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 138 */ {EOS_Als_Pv,    "EOS_Als_Pv",    401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Als,       EOS_Pv,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Als_T,        EOS_T_Pv,         EOS_FALSE, "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg) (Vapor Pressure (GPa)-dependent)"},
  /* 139 */ {EOS_Als_Dv,    "EOS_Als_Dv",    401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Als,       EOS_Dv,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Als_T,        EOS_T_Dv,         EOS_FALSE, "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg) (Vapor Density on coexistence line (Mg/m^3)-dependent)"},

  /*         eosTableType   *eosTableType_s  tableNum  subTableNum  recordType            category       subCategory        depVar         indepVar1      indepVar2      eosTempBalFunc  eosPresBalFunc  eosTableTypeRef1  eosTableTypeRef2  logAxes    *eosTableName */
  /* 140 */ {EOS_Als_Dls,   "EOS_Als_Dls",   401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Als,       EOS_Dls,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Als_T,        EOS_T_Dls,        EOS_FALSE, "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg) (Liquid or Solid Density on coexistence line (Mg/m^3)-dependent)"},
  /* 141 */ {EOS_Als_Uv,    "EOS_Als_Uv",    401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Als,       EOS_Uv,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Als_T,        EOS_T_Uv,         EOS_FALSE, "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg) (Vapor Specific-Internal-Energy (MJ/kg)-dependent)"},
  /* 142 */ {EOS_Als_Uls,   "EOS_Als_Uls",   401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Als,       EOS_Uls,       EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Als_T,        EOS_T_Uls,        EOS_FALSE, "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg) (Liquid or Solid Specific-Internal-Energy (MJ/kg)-dependent)"},
  /* 143 */ {EOS_Als_Av,    "EOS_Als_Av",    401,      7,           EOS_RECORD_TYPE2,     EOS_CATEGORY3, EOS_VAPORIZATION,  EOS_Als,       EOS_Av,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Als_T,        EOS_T_Av,         EOS_FALSE, "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg) (Vapor Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 148 */ {EOS_Tm_Am,     "EOS_Tm_Am",     411,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Tm,        EOS_Am,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Tm_D,         EOS_D_Am,         EOS_FALSE, "Melt Temperature (K) (Melt Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 153 */ {EOS_Pm_Am,     "EOS_Pm_Am",     411,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Pm,        EOS_Am,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Pm_D,         EOS_D_Am,         EOS_FALSE, "Melt Pressure (GPa) (Melt Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 158 */ {EOS_Um_Am,     "EOS_Um_Am",     411,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Um,        EOS_Am,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Um_D,         EOS_D_Am,         EOS_FALSE, "Melt Specific-Internal-Energy (MJ/kg) (Melt Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 159 */ {EOS_Am_D,      "EOS_Am_D",      411,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_MELT,          EOS_Am,        EOS_D,         EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Melt Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)-dependent)"},

  /*         eosTableType   *eosTableType_s  tableNum  subTableNum  recordType            category       subCategory        depVar         indepVar1      indepVar2      eosTempBalFunc  eosPresBalFunc  eosTableTypeRef1  eosTableTypeRef2  logAxes    *eosTableName */
  /* 160 */ {EOS_D_Am,      "EOS_D_Am",      411,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY1, EOS_MELT,          EOS_D,         EOS_Am,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Density (Mg/m^3) (Melt Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 161 */ {EOS_Am_Tm,     "EOS_Am_Tm",     411,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Am,        EOS_Tm,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Am_D,         EOS_D_Tm,         EOS_FALSE, "Melt Specific-Helmholtz-Free-Energy (MJ/kg) (Melt Temperature (K)-dependent)"},
  /* 162 */ {EOS_Am_Pm,     "EOS_Am_Pm",     411,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Am,        EOS_Pm,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Am_D,         EOS_D_Pm,         EOS_FALSE, "Melt Specific-Helmholtz-Free-Energy (MJ/kg) (Melt Pressure (GPa)-dependent)"},
  /* 163 */ {EOS_Am_Um,     "EOS_Am_Um",     411,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Am,        EOS_Um,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Am_D,         EOS_D_Um,         EOS_FALSE, "Melt Specific-Helmholtz-Free-Energy (MJ/kg) (Melt Specific-Internal-Energy (MJ/kg)-dependent)"},
  ...
  /* 168 */ {EOS_Tf_Af,     "EOS_Tf_Af",     412,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Tf,        EOS_Af,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Tf_D,         EOS_D_Af,         EOS_FALSE, "Freeze Temperature (K) (Freeze Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 173 */ {EOS_Pf_Af,     "EOS_Pf_Af",     412,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Pf,        EOS_Af,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Pf_D,         EOS_D_Af,         EOS_FALSE, "Freeze Pressure (GPa) (Freeze Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  ...
  /* 178 */ {EOS_Uf_Af,     "EOS_Uf_Af",     412,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Uf,        EOS_Af,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Uf_D,         EOS_D_Af,         EOS_FALSE, "Freeze Specific-Internal-Energy (MJ/kg) (Freeze Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 179 */ {EOS_Af_D,      "EOS_Af_D",      412,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_MELT,          EOS_Af,        EOS_D,         EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Freeze Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)-dependent)"},

  /*         eosTableType   *eosTableType_s  tableNum  subTableNum  recordType            category       subCategory        depVar         indepVar1      indepVar2      eosTempBalFunc  eosPresBalFunc  eosTableTypeRef1  eosTableTypeRef2  logAxes    *eosTableName */
  /* 180 */ {EOS_D_Af,      "EOS_D_Af",      412,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY1, EOS_MELT,          EOS_D,         EOS_Af,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Density (Mg/m^3) (Freeze Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 181 */ {EOS_Af_Tf,     "EOS_Af_Tf",     412,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Af,        EOS_Tf,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Af_D,         EOS_D_Tf,         EOS_FALSE, "Freeze Specific-Helmholtz-Free-Energy (MJ/kg) (Freeze Temperature (K)-dependent)"},
  /* 182 */ {EOS_Af_Pf,     "EOS_Af_Pf",     412,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Af,        EOS_Pf,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Af_D,         EOS_D_Pf,         EOS_FALSE, "Freeze Specific-Helmholtz-Free-Energy (MJ/kg) (Freeze Pressure (GPa)-dependent)"},
  /* 183 */ {EOS_Af_Uf,     "EOS_Af_Uf",     412,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY3, EOS_MELT,          EOS_Af,        EOS_Uf,        EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_Af_D,         EOS_D_Uf,         EOS_FALSE, "Freeze Specific-Helmholtz-Free-Energy (MJ/kg) (Freeze Specific-Internal-Energy (MJ/kg)-dependent)"},
  ...
  /*         eosTableType   *eosTableType_s  tableNum  subTableNum  recordType            category       subCategory        depVar         indepVar1      indepVar2      eosTempBalFunc  eosPresBalFunc  eosTableTypeRef1  eosTableTypeRef2  logAxes    *eosTableName */
  /* 217 */ {EOS_Gt_DT,     "EOS_Gt_DT",     301,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_TOTAL,         EOS_Gt,        EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /* 218 */ {EOS_T_DGt,     "EOS_T_DGt",     301,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_TOTAL,         EOS_T,         EOS_D,         EOS_Gt,        EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 219 */ {EOS_Pt_DGt,    "EOS_Pt_DGt",    301,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Pt,        EOS_D,         EOS_Gt,        EOS_NullTable,  EOS_NullTable,  EOS_Pt_DT,        EOS_T_DGt,        EOS_FALSE, "Total Pressure (GPa) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 220 */ {EOS_Ut_DGt,    "EOS_Ut_DGt",    301,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Ut,        EOS_D,         EOS_Gt,        EOS_NullTable,  EOS_NullTable,  EOS_Ut_DT,        EOS_T_DGt,        EOS_FALSE, "Total Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 221 */ {EOS_At_DGt,    "EOS_At_DGt",    301,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_At,        EOS_D,         EOS_Gt,        EOS_NullTable,  EOS_NullTable,  EOS_At_DT,        EOS_T_DGt,        EOS_FALSE, "Total Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 222 */ {EOS_St_DGt,    "EOS_St_DGt",    301,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_St,        EOS_D,         EOS_Gt,        EOS_NullTable,  EOS_NullTable,  EOS_St_DT,        EOS_T_DGt,        EOS_FALSE, "Total Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 223 */ {EOS_Gt_DPt,    "EOS_Gt_DPt",    301,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Gt,        EOS_D,         EOS_Pt,        EOS_NullTable,  EOS_NullTable,  EOS_Gt_DT,        EOS_T_DPt,        EOS_FALSE, "Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Pressure (GPa)-dependent)"},
  /* 224 */ {EOS_Gt_DUt,    "EOS_Gt_DUt",    301,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Gt,        EOS_D,         EOS_Ut,        EOS_NullTable,  EOS_NullTable,  EOS_Gt_DT,        EOS_T_DUt,        EOS_FALSE, "Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Internal-Energy (MJ/kg)-dependent)"},
  /* 225 */ {EOS_Gt_DAt,    "EOS_Gt_DAt",    301,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Gt,        EOS_D,         EOS_At,        EOS_NullTable,  EOS_NullTable,  EOS_Gt_DT,        EOS_T_DAt,        EOS_FALSE, "Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 226 */ {EOS_Gt_DSt,    "EOS_Gt_DSt",    301,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_TOTAL,         EOS_Gt,        EOS_D,         EOS_St,        EOS_NullTable,  EOS_NullTable,  EOS_Gt_DT,        EOS_T_DSt,        EOS_FALSE, "Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Entropy (MJ/kg/K)-dependent)"},
  /* 227 */ {EOS_Gic_DT,    "EOS_Gic_DT",    303,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_ION_PLUS_COLD, EOS_Gic,       EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /* 228 */ {EOS_T_DGic,    "EOS_T_DGic",    303,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_ION_PLUS_COLD, EOS_T,         EOS_D,         EOS_Gic,       EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 229 */ {EOS_Pic_DGic,  "EOS_Pic_DGic",  303,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Pic,       EOS_D,         EOS_Gic,       EOS_NullTable,  EOS_NullTable,  EOS_Pic_DT,       EOS_T_DGic,       EOS_FALSE, "Ion Pressure plus Cold Curve Pressure (GPa) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 230 */ {EOS_Uic_DGic,  "EOS_Uic_DGic",  303,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Uic,       EOS_D,         EOS_Gic,       EOS_NullTable,  EOS_NullTable,  EOS_Uic_DT,       EOS_T_DGic,       EOS_FALSE, "Ion Specific-Internal-Energy plus Cold Curve Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 231 */ {EOS_Aic_DGic,  "EOS_Aic_DGic",  303,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Aic,       EOS_D,         EOS_Gic,       EOS_NullTable,  EOS_NullTable,  EOS_Aic_DT,       EOS_T_DGic,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 232 */ {EOS_Sic_DGic,  "EOS_Sic_DGic",  303,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Sic,       EOS_D,         EOS_Gic,       EOS_NullTable,  EOS_NullTable,  EOS_Sic_DT,       EOS_T_DGic,       EOS_FALSE, "Ion Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 233 */ {EOS_Gic_DPic,  "EOS_Gic_DPic",  303,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Gic,       EOS_D,         EOS_Pic,       EOS_NullTable,  EOS_NullTable,  EOS_Gic_DT,       EOS_T_DPic,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Pressure plus Cold Curve Pressure (GPa)-dependent)"},
  /* 234 */ {EOS_Gic_DUic,  "EOS_Gic_DUic",  303,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Gic,       EOS_D,         EOS_Uic,       EOS_NullTable,  EOS_NullTable,  EOS_Gic_DT,       EOS_T_DUic,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Internal-Energy plus Cold Curve Specific-Internal-Energy (MJ/kg)-dependent)"},
  /* 235 */ {EOS_Gic_DAic,  "EOS_Gic_DAic",  303,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Gic,       EOS_D,         EOS_Aic,       EOS_NullTable,  EOS_NullTable,  EOS_Gic_DT,       EOS_T_DAic,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 236 */ {EOS_Gic_DSic,  "EOS_Gic_DSic",  303,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION_PLUS_COLD, EOS_Gic,       EOS_D,         EOS_Sic,       EOS_NullTable,  EOS_NullTable,  EOS_Gic_DT,       EOS_T_DSic,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Entropy plus Cold Curve Specific-Entropy (MJ/kg/K)-dependent)"},

  /*         eosTableType   *eosTableType_s  tableNum  subTableNum  recordType            category       subCategory        depVar         indepVar1      indepVar2      eosTempBalFunc  eosPresBalFunc  eosTableTypeRef1  eosTableTypeRef2  logAxes    *eosTableName */
  /* 217 */ {EOS_Ge_DT,     "EOS_Ge_DT",     304,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_ELECTRON,      EOS_Ge,        EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /* 218 */ {EOS_T_DGe,     "EOS_T_DGe",     304,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_ELECTRON,      EOS_T,         EOS_D,         EOS_Ge,        EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 219 */ {EOS_Pe_DGe,    "EOS_Pe_DGe",    304,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Pe,        EOS_D,         EOS_Ge,        EOS_NullTable,  EOS_NullTable,  EOS_Pe_DT,        EOS_T_DGe,        EOS_FALSE, "Electron Pressure (GPa) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 220 */ {EOS_Ue_DGe,    "EOS_Ue_DGe",    304,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ue,        EOS_D,         EOS_Ge,        EOS_NullTable,  EOS_NullTable,  EOS_Ue_DT,        EOS_T_DGe,        EOS_FALSE, "Electron Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 221 */ {EOS_Ae_DGe,    "EOS_Ae_DGe",    304,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ae,        EOS_D,         EOS_Ge,        EOS_NullTable,  EOS_NullTable,  EOS_Ae_DT,        EOS_T_DGe,        EOS_FALSE, "Electron Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 222 */ {EOS_Se_DGe,    "EOS_Se_DGe",    304,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Se,        EOS_D,         EOS_Ge,        EOS_NullTable,  EOS_NullTable,  EOS_Se_DT,        EOS_T_DGe,        EOS_FALSE, "Electron Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 223 */ {EOS_Ge_DPe,    "EOS_Ge_DPe",    304,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ge,        EOS_D,         EOS_Pe,        EOS_NullTable,  EOS_NullTable,  EOS_Ge_DT,        EOS_T_DPe,        EOS_FALSE, "Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Pressure (GPa)-dependent)"},
  /* 224 */ {EOS_Ge_DUe,    "EOS_Ge_DUe",    304,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ge,        EOS_D,         EOS_Ue,        EOS_NullTable,  EOS_NullTable,  EOS_Ge_DT,        EOS_T_DUe,        EOS_FALSE, "Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Internal-Energy (MJ/kg)-dependent)"},
  /* 225 */ {EOS_Ge_DAe,    "EOS_Ge_DAe",    304,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ge,        EOS_D,         EOS_Ae,        EOS_NullTable,  EOS_NullTable,  EOS_Ge_DT,        EOS_T_DAe,        EOS_FALSE, "Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Helmholtz-Free-Energy (MJ/kg)-dependent)"},
  /* 226 */ {EOS_Ge_DSe,    "EOS_Ge_DSe",    304,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ELECTRON,      EOS_Ge,        EOS_D,         EOS_Se,        EOS_NullTable,  EOS_NullTable,  EOS_Ge_DT,        EOS_T_DSe,        EOS_FALSE, "Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Entropy (MJ/kg/K)-dependent)"},
  /* 227 */ {EOS_Giz_DT,    "EOS_Giz_DT",    305,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_ION,           EOS_Giz,       EOS_D,         EOS_T,         EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent)"},
  /* 228 */ {EOS_T_DGiz,    "EOS_T_DGiz",    305,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY2, EOS_ION,           EOS_T,         EOS_D,         EOS_Giz,       EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Temperature (K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  /* 229 */ {EOS_Piz_DGiz,  "EOS_Piz_DGiz",  305,      1,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Piz,       EOS_D,         EOS_Giz,       EOS_NullTable,  EOS_NullTable,  EOS_Piz_DT,       EOS_T_DGiz,       EOS_FALSE, "Ion Pressure Including Zero Point (GPa) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  /* 230 */ {EOS_Uiz_DGiz,  "EOS_Uiz_DGiz",  305,      2,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Uiz,       EOS_D,         EOS_Giz,       EOS_NullTable,  EOS_NullTable,  EOS_Uiz_DT,       EOS_T_DGiz,       EOS_FALSE, "Ion Specific-Internal-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  /* 231 */ {EOS_Aiz_DGiz,  "EOS_Aiz_DGiz",  305,      3,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Aiz,       EOS_D,         EOS_Giz,       EOS_NullTable,  EOS_NullTable,  EOS_Aiz_DT,       EOS_T_DGiz,       EOS_FALSE, "Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  /* 232 */ {EOS_Siz_DGiz,  "EOS_Siz_DGiz",  305,      4,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Siz,       EOS_D,         EOS_Giz,       EOS_NullTable,  EOS_NullTable,  EOS_Siz_DT,       EOS_T_DGiz,       EOS_FALSE, "Ion Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy (MJ/kg)-dependent)"},
  /* 233 */ {EOS_Giz_DPiz,  "EOS_Giz_DPiz",  305,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Giz,       EOS_D,         EOS_Piz,       EOS_NullTable,  EOS_NullTable,  EOS_Giz_DT,       EOS_T_DPiz,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Pressure Including Zero Point (GPa)-dependent)"},
  /* 234 */ {EOS_Giz_DUiz,  "EOS_Giz_DUiz",  305,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Giz,       EOS_D,         EOS_Uiz,       EOS_NullTable,  EOS_NullTable,  EOS_Giz_DT,       EOS_T_DUiz,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Internal-Energy Including Zero Point (MJ/kg)-dependent)"},
  /* 235 */ {EOS_Giz_DAiz,  "EOS_Giz_DAiz",  305,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Giz,       EOS_D,         EOS_Aiz,       EOS_NullTable,  EOS_NullTable,  EOS_Giz_DT,       EOS_T_DAiz,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg)-dependent)"},
  /* 236 */ {EOS_Giz_DSiz,  "EOS_Giz_DSiz",  305,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY4, EOS_ION,           EOS_Giz,       EOS_D,         EOS_Siz,       EOS_NullTable,  EOS_NullTable,  EOS_Giz_DT,       EOS_T_DSiz,       EOS_FALSE, "Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Entropy Including Zero Point (MJ/kg/K)-dependent)"},

  /*         eosTableType   *eosTableType_s  tableNum  subTableNum  recordType            category       subCategory        depVar         indepVar1      indepVar2      eosTempBalFunc  eosPresBalFunc  eosTableTypeRef1  eosTableTypeRef2  logAxes    *eosTableName */
  /* 237 */ {EOS_Gc_D,      "EOS_Gc_D",      306,      5,           EOS_RECORD_TYPE1,     EOS_CATEGORY0, EOS_COLD,          EOS_Gc,        EOS_D,         EOS_NullTable, EOS_NullTable,  EOS_NullTable,  EOS_NullTable,    EOS_NullTable,    EOS_FALSE, "Specific-Gibbs-Free-Energy Cold Curve (MJ/kg) (Density (Mg/m^3)-dependent)"}
};
...
eos_VarTypeData _eos_VarList[] = {
  ...
  {EOS_Ac,  "EOS_Ac",  "Ac",  "Specific-Helmholtz-Free-Energy Cold Curve (MJ/kg)"},
  {EOS_Ae,  "EOS_Ae",  "Ae",  "Electron Specific-Helmholtz-Free-Energy (MJ/kg)"},
  {EOS_Af,  "EOS_Af",  "Af",  "Freeze Specific-Helmholtz-Free-Energy (MJ/kg)"},
  {EOS_Aiz, "EOS_Aiz", "Aiz", "Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg)"},
  {EOS_Aic, "EOS_Aic", "Aic", "Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg)"},
  {EOS_Als, "EOS_Als", "Als", "Liquid or Solid Specific-Helmholtz-Free-Energy (MJ/kg)"},
  {EOS_Am,  "EOS_Am",  "Am",  "Melt Specific-Helmholtz-Free-Energy (MJ/kg)"},
  {EOS_Gs,  "EOS_Gs",  "Gs",  "Shear Modulus (Gpa)"},
  {EOS_At,  "EOS_At",  "At",  "Total Specific-Helmholtz-Free-Energy (MJ/kg)"},
  {EOS_Av,  "EOS_Av",  "Av",  "Vapor Specific-Helmholtz-Free-Energy (MJ/kg)"},
  ...
  {EOS_Gt,  "EOS_Gt",  "Gt",  "Total Specific-Gibbs-Free-Energy (MJ/kg)"},
  {EOS_Gic, "EOS_Gic", "Gic", "Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)"},
  {EOS_Ge,  "EOS_Ge",  "Ge",  "Electron Specific-Gibbs-Free-Energy (MJ/kg)"},
  {EOS_Giz, "EOS_Giz", "Giz", "Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)"},
  {EOS_Gc,  "EOS_Gc",  "Gc",  "Specific-Gibbs-Free-Energy Cold Curve (MJ/kg)"}
};
...
#ifdef DO_OFFLOAD
/* Set/Get gEosDataMap.useGpuData value */
#define _EOS_SET_USEGPUDATA_EOSDATAMAP(b) gEosDataMap.useGpuData=b
#define _EOS_GET_USEGPUDATA_EOSDATAMAP gEosDataMap.useGpuData
#endif /* DO_OFFLOAD */
#define _EOS_SET_SKIPEXTRAPCHECK_EOSDATAMAP(b) gEosDataMap.skipExtrapCheck=b
#define _EOS_GET_SKIPEXTRAPCHECK_EOSDATAMAP gEosDataMap.skipExtrapCheck
