...
void _eos_CompressArray (EOS_REAL * a, EOS_INTEGER * n, EOS_INTEGER n_target, EOS_CHAR ** errMsg,
                         EOS_INTEGER * ia);
void _eos_CreateGhostData (EOS_BOOLEAN _create_ghostdata,
                           EOS_INTEGER nGhostData, EOS_INTEGER nxtbl_in, EOS_INTEGER nytbl_in, EOS_REAL * xtbls_in,
...
void _eos_InterpolateRecordType_1D (EOS_BOOLEAN _create_ghostdata,
                                    EOS_INTEGER nX, EOS_REAL * X, EOS_REAL * F, EOS_REAL * F2, EOS_INTEGER th,
                                    EOS_INTEGER dataType, EOS_INTEGER nXYPairs, EOS_REAL * srchX, EOS_REAL * fVals,
                                    EOS_REAL * dFx, eos_HashTable1D* X_ht, eos_HashTable1D* F_ht, EOS_INTEGER * xyBounds, EOS_INTEGER * errorCode,
                                    EOS_CHAR ** errMsg);
#ifdef DO_OFFLOAD
void
_eos_InterpolateRecordType_1D_GpuLimited (EOS_BOOLEAN _create_ghostdata, EOS_INTEGER nX, EOS_REAL * X, EOS_REAL * F, EOS_REAL * F2, EOS_INTEGER th, EOS_INTEGER dataType, EOS_INTEGER nXYPairs, EOS_REAL * srchX, EOS_REAL * fVals, EOS_REAL * dFx, EOS_INTEGER * xyBounds, EOS_INTEGER * errorCode, EOS_CHAR ** errMsg);
#endif
...
void _eos_CopyValuesOfArraysWithCustomExtents (EOS_INTEGER nxtbl, EOS_INTEGER nytbl, EOS_REAL *X, EOS_REAL *Y, EOS_REAL *F,
...
/*
 * -----------------------------------------------
 * 25 PRIVATE FUNCTION PROTOTYPES FOR eos_Utils.c
 * -----------------------------------------------
 */
void _eos_GetInvertedTable_CATEGORY1 (EOS_INTEGER th, EOS_INTEGER dataType, EOS_REAL ** xtbls, EOS_REAL ** ytbls,
                                      ...
                                      EOS_INTEGER * nytbl, EOS_INTEGER nGhostData, EOS_REAL ** xtbls_invt, EOS_REAL ** ytbls_invt,
