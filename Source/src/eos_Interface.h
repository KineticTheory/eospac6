...
static const EOS_INTEGER EOS_Pt_DAt    = 7; /* Total Pressure (Density- and Total Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Ut_DAt    = 16; /* Total Specific-Internal-Energy (Density- and Total Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_At_DT     = 21; /* Total Specific-Helmholtz-Free-Energy (Density- and Temperature-dependent) */
static const EOS_INTEGER EOS_T_DAt     = 23; /* Temperature (Density- and Total Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_At_DPt    = 24; /* Total Specific-Helmholtz-Free-Energy (Density- and Total Pressure-dependent) */
static const EOS_INTEGER EOS_At_DUt    = 25; /* Total Specific-Helmholtz-Free-Energy (Density- and Total Specific-Internal-Energy-dependent) */
static const EOS_INTEGER EOS_At_DSt    = 26; /* Total Specific-Helmholtz-Free-Energy (Density- and Total Specific-Entropy-dependent) */
...
static const EOS_INTEGER EOS_St_DAt    = 35; /* Total Specific-Entropy (Density- and Total Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Pic_DAic  = 43; /* Ion Pressure plus Cold Curve Pressure (Density- and Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Uic_DAic  = 52; /* Ion Specific-Internal-Energy plus Cold Curve Specific-Internal-Energy (Density- and Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Aic_DT    = 57; /* Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (Density- and Temperature-dependent) */
static const EOS_INTEGER EOS_T_DAic    = 59; /* Temperature (Density- and Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Aic_DPic  = 60; /* Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (Density- and Ion Pressure plus Cold Curve Pressure-dependent) */
static const EOS_INTEGER EOS_Aic_DUic  = 61; /* Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (Density- and Ion Specific-Internal-Energy plus Cold Curve Specific-Internal-Energy-dependent) */
static const EOS_INTEGER EOS_Aic_DSic  = 62; /* Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (Density- and Ion Pressure plus Cold Curve Specific-Entropy-dependent) */
...
static const EOS_INTEGER EOS_Sic_DAic  = 71; /* Ion Pressure plus Cold Curve Specific-Entropy (Density- and Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Pe_DAe    = 79; /* Electron Pressure (Density- and Electron Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Ue_DAe    = 88; /* Electron Specific-Internal-Energy (Density- and Electron Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Ue_DSe    = 89; /* Electron Specific-Internal-Energy (Density- and Electron Specific-Entropy-dependent) */
static const EOS_INTEGER EOS_Ae_DT     = 93; /* Electron Specific-Helmholtz-Free-Energy (Density- and Temperature-dependent) */
static const EOS_INTEGER EOS_T_DAe     = 95; /* Temperature (Density- and Electron Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Ae_DPe    = 96; /* Electron Specific-Helmholtz-Free-Energy (Density- and Electron Pressure-dependent) */
static const EOS_INTEGER EOS_Ae_DUe    = 97; /* Electron Specific-Helmholtz-Free-Energy (Density- and Electron Specific-Internal-Energy-dependent) */
static const EOS_INTEGER EOS_Ae_DSe    = 98; /* Electron Specific-Helmholtz-Free-Energy (Density- and Electron Specific-Entropy-dependent) */
...
static const EOS_INTEGER EOS_Se_DAe    = 107; /* Electron Specific-Entropy (Density- and Electron Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Piz_DAiz  = 115; /* Ion Pressure Including Zero Point (Density- and Ion Specific-Helmholtz-Free-Energy Including Zero Point-dependent) */
...
static const EOS_INTEGER EOS_Uiz_DAiz  = 124; /* Ion Specific-Internal-Energy Including Zero Point (Density- and Ion Specific-Helmholtz-Free-Energy Including Zero Point-dependent) */
...
static const EOS_INTEGER EOS_Aiz_DT    = 129; /* Ion Specific-Helmholtz-Free-Energy Including Zero Point (Density- and Temperature-dependent) */
static const EOS_INTEGER EOS_T_DAiz    = 131; /* Temperature (Density- and Ion Specific-Helmholtz-Free-Energy Including Zero Point-dependent) */
static const EOS_INTEGER EOS_Aiz_DPiz  = 132; /* Ion Specific-Helmholtz-Free-Energy Including Zero Point (Density- and Ion Pressure Including Zero Point-dependent) */
static const EOS_INTEGER EOS_Aiz_DUiz  = 133; /* Ion Specific-Helmholtz-Free-Energy Including Zero Point (Density- and Ion Specific-Internal-Energy Including Zero Point-dependent) */
static const EOS_INTEGER EOS_Aiz_DSiz  = 134; /* Ion Specific-Helmholtz-Free-Energy Including Zero Point (Density- and Ion Pressure Including Zero Specific-Entropy-dependent) */
...
static const EOS_INTEGER EOS_Siz_DAiz  = 143; /* Ion Pressure Including Zero Specific-Entropy (Density- and Ion Specific-Helmholtz-Free-Energy Including Zero Point-dependent) */
...
static const EOS_INTEGER EOS_Ac_D      = 155; /* Specific-Helmholtz-Free-Energy Cold Curve (Density-dependent) */
...
static const EOS_INTEGER EOS_Pv_Av     = 165; /* Vapor Pressure (Vapor Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Pv_Als    = 166; /* Vapor Pressure (Liquid or Solid Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Dv_Av     = 173; /* Vapor Density on coexistence line (Vapor Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Dv_Als    = 174; /* Vapor Density on coexistence line (Liquid or Solid Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Dls_Av    = 181; /* Liquid or Solid Density on coexistence line (Vapor Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Dls_Als   = 182; /* Liquid or Solid Density on coexistence line (Liquid or Solid Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Uv_Av     = 189; /* Vapor Specific-Internal-Energy (Vapor Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Uv_Als    = 190; /* Vapor Specific-Internal-Energy (Liquid or Solid Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Uls_Av    = 197; /* Liquid or Solid Specific-Internal-Energy (Vapor Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Uls_Als   = 198; /* Liquid or Solid Specific-Internal-Energy (Liquid or Solid Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Av_T      = 199; /* Vapor Specific-Helmholtz-Free-Energy (Temperature-dependent) */
static const EOS_INTEGER EOS_T_Av      = 200; /* Temperature (Vapor Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Av_Pv     = 201; /* Vapor Specific-Helmholtz-Free-Energy (Vapor Pressure-dependent) */
static const EOS_INTEGER EOS_Av_Dv     = 202; /* Vapor Specific-Helmholtz-Free-Energy (Vapor Density on coexistence line-dependent) */
static const EOS_INTEGER EOS_Av_Dls    = 203; /* Vapor Specific-Helmholtz-Free-Energy (Liquid or Solid Density on coexistence line-dependent) */
static const EOS_INTEGER EOS_Av_Uv     = 204; /* Vapor Specific-Helmholtz-Free-Energy (Vapor Specific-Internal-Energy-dependent) */
static const EOS_INTEGER EOS_Av_Uls    = 205; /* Vapor Specific-Helmholtz-Free-Energy (Liquid or Solid Specific-Internal-Energy-dependent) */
static const EOS_INTEGER EOS_Av_Als    = 206; /* Vapor Specific-Helmholtz-Free-Energy (Liquid or Solid Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Als_T     = 207; /* Liquid or Solid Specific-Helmholtz-Free-Energy (Temperature-dependent) */
static const EOS_INTEGER EOS_T_Als     = 208; /* Temperature (Liquid or Solid Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Als_Pv    = 209; /* Liquid or Solid Specific-Helmholtz-Free-Energy (Vapor Pressure-dependent) */
static const EOS_INTEGER EOS_Als_Dv    = 210; /* Liquid or Solid Specific-Helmholtz-Free-Energy (Vapor Density on coexistence line-dependent) */
static const EOS_INTEGER EOS_Als_Dls   = 211; /* Liquid or Solid Specific-Helmholtz-Free-Energy (Liquid or Solid Density on coexistence line-dependent) */
static const EOS_INTEGER EOS_Als_Uv    = 212; /* Liquid or Solid Specific-Helmholtz-Free-Energy (Vapor Specific-Internal-Energy-dependent) */
static const EOS_INTEGER EOS_Als_Uls   = 213; /* Liquid or Solid Specific-Helmholtz-Free-Energy (Liquid or Solid Specific-Internal-Energy-dependent) */
static const EOS_INTEGER EOS_Als_Av    = 214; /* Liquid or Solid Specific-Helmholtz-Free-Energy (Vapor Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Tm_Am     = 219; /* Melt Temperature (Melt Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Pm_Am     = 224; /* Melt Pressure (Melt Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Um_Am     = 229; /* Melt Specific-Internal-Energy (Melt Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Am_D      = 230; /* Melt Specific-Helmholtz-Free-Energy (Density-dependent) */
static const EOS_INTEGER EOS_D_Am      = 231; /* Density (Melt Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Am_Tm     = 232; /* Melt Specific-Helmholtz-Free-Energy (Melt Temperature-dependent) */
static const EOS_INTEGER EOS_Am_Pm     = 233; /* Melt Specific-Helmholtz-Free-Energy (Melt Pressure-dependent) */
static const EOS_INTEGER EOS_Am_Um     = 234; /* Melt Specific-Helmholtz-Free-Energy (Melt Specific-Internal-Energy-dependent) */
...
static const EOS_INTEGER EOS_Tf_Af     = 239; /* Freeze Temperature (Freeze Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Pf_Af     = 244; /* Freeze Pressure (Freeze Specific-Helmholtz-Free-Energy-dependent) */
...
static const EOS_INTEGER EOS_Uf_Af     = 249; /* Freeze Specific-Internal-Energy (Freeze Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Af_D      = 250; /* Freeze Specific-Helmholtz-Free-Energy (Density-dependent) */
static const EOS_INTEGER EOS_D_Af      = 251; /* Density (Freeze Specific-Helmholtz-Free-Energy-dependent) */
static const EOS_INTEGER EOS_Af_Tf     = 252; /* Freeze Specific-Helmholtz-Free-Energy (Freeze Temperature-dependent) */
static const EOS_INTEGER EOS_Af_Pf     = 253; /* Freeze Specific-Helmholtz-Free-Energy (Freeze Pressure-dependent) */
static const EOS_INTEGER EOS_Af_Uf     = 254; /* Freeze Specific-Helmholtz-Free-Energy (Freeze Specific-Internal-Energy-dependent) */
...
static const EOS_INTEGER EOS_Gt_DT     = 310; /* Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent) */
static const EOS_INTEGER EOS_T_DGt     = 311; /* Temperature (K) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Pt_DGt    = 312; /* Total Pressure (GPa) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Ut_DGt    = 313; /* Total Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_At_DGt    = 314; /* Total Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_St_DGt    = 315; /* Total Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Total Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Gt_DPt    = 316; /* Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Pressure (GPa)-dependent) */
static const EOS_INTEGER EOS_Gt_DUt    = 317; /* Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Internal-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Gt_DAt    = 318; /* Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Helmholtz-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Gt_DSt    = 319; /* Total Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Total Specific-Entropy (MJ/kg/K)-dependent) */
static const EOS_INTEGER EOS_Gic_DT    = 320; /* Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent) */
static const EOS_INTEGER EOS_T_DGic    = 321; /* Temperature (K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Pic_DGic  = 322; /* Ion Pressure plus Cold Curve Pressure (GPa) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Uic_DGic  = 323; /* Ion Specific-Internal-Energy plus Cold Curve Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Aic_DGic  = 324; /* Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Sic_DGic  = 325; /* Ion Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Gic_DPic  = 326; /* Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Pressure plus Cold Curve Pressure (GPa)-dependent) */
static const EOS_INTEGER EOS_Gic_DUic  = 327; /* Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Internal-Energy plus Cold Curve Specific-Internal-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Gic_DAic  = 328; /* Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy plus Cold Curve Specific-Helmholtz-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Gic_DSic  = 329; /* Ion Specific-Gibbs-Free-Energy plus Cold Curve Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Entropy plus Cold Curve Specific-Entropy (MJ/kg/K)-dependent) */
static const EOS_INTEGER EOS_Ge_DT     = 330; /* Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent) */
static const EOS_INTEGER EOS_T_DGe     = 331; /* Temperature (K) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Pe_DGe    = 332; /* Electron Pressure (GPa) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Ue_DGe    = 333; /* Electron Specific-Internal-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Ae_DGe    = 334; /* Electron Specific-Helmholtz-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Se_DGe    = 335; /* Electron Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Electron Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Ge_DPe    = 336; /* Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Pressure (GPa)-dependent) */
static const EOS_INTEGER EOS_Ge_DUe    = 337; /* Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Internal-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Ge_DAe    = 338; /* Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Helmholtz-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Ge_DSe    = 339; /* Electron Specific-Gibbs-Free-Energy (MJ/kg) (Density (Mg/m^3)- and Electron Specific-Entropy (MJ/kg/K)-dependent) */
static const EOS_INTEGER EOS_Giz_DT    = 340; /* Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Temperature (K)-dependent) */
static const EOS_INTEGER EOS_T_DGiz    = 341; /* Temperature (K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Piz_DGiz  = 342; /* Ion Pressure Including Zero Point (GPa) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Uiz_DGiz  = 343; /* Ion Specific-Internal-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Aiz_DGiz  = 344; /* Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Siz_DGiz  = 345; /* Ion Specific-Entropy (MJ/kg/K) (Density (Mg/m^3)- and Ion Specific-Gibbs-Free-Energy (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Giz_DPiz  = 346; /* Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Pressure Including Zero Point (GPa)-dependent) */
static const EOS_INTEGER EOS_Giz_DUiz  = 347; /* Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Internal-Energy Including Zero Point (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Giz_DAiz  = 348; /* Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Helmholtz-Free-Energy Including Zero Point (MJ/kg)-dependent) */
static const EOS_INTEGER EOS_Giz_DSiz  = 349; /* Ion Specific-Gibbs-Free-Energy Including Zero Point (MJ/kg) (Density (Mg/m^3)- and Ion Specific-Entropy Including Zero Point (MJ/kg/K)-dependent) */
static const EOS_INTEGER EOS_Gc_D      = 350; /* Specific-Gibbs-Free-Energy Cold Curve (MJ/kg) (Density (Mg/m^3)-dependent) */

/* Table setup and interpolation option constants */
#define EOS_NUM_TABLE_OPTIONS    30     /* Total number of public option flags */
...
static const EOS_INTEGER EOS_USE_HOST_XY = 1028; /* Enable EOS_XY_MODIFY, and enable logic to revert the modified xVals and yVals inputs after interpolation is completed */
static const EOS_INTEGER EOS_SKIP_EXTRAP_CHECK = 1029; /* All extrapolation checks are skipped in all eospac calls except eos_CheckExtrapolation */
...
static const EOS_INTEGER EOS_X_LOWER_BOUND = 38;   /* The extrapolation lower bound(s) array, of extent EOS_NX, for the xVals */
static const EOS_INTEGER EOS_X_UPPER_BOUND = 39;   /* The extrapolation upper bound(s) array, of extent EOS_NX, for the xVals */
static const EOS_INTEGER EOS_Y_LOWER_BOUND = 40;   /* The extrapolation lower bound(s) array, of extent EOS_NY, for the yVals */
static const EOS_INTEGER EOS_Y_UPPER_BOUND = 41;   /* The extrapolation upper bound(s) array, of extent EOS_NY, for the yVals */
static const EOS_INTEGER EOS_NX            = 42;   /* The extent of the xVals extrapolation lower/upper bound(s) arrays */
static const EOS_INTEGER EOS_NY            = 43;   /* The extent of the yVals extrapolation lower/upper bound(s) arrays */
static const EOS_INTEGER EOS_X_BOUND_GRID  = 44;   /* The extrapolation bound(s) grid array, of extent EOS_NX, for the xVals */
static const EOS_INTEGER EOS_Y_BOUND_GRID  = 45;   /* The extrapolation bound(s) grid array, of extent EOS_NY, for the yVals */
