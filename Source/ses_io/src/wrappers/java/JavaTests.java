...
public class JavaTests
{
    ...
    public static void test_ses_set_format() {
        ...
        ses_ascii_word_type the_ascii_word_type = 'M';
...
#ifdef TRY_OPTIONAL
        set_format.the_value = my_ses_io.SesSetFormat(2, the_handle.the_value, 'A');
#else
        set_format.the_value = my_ses_io.SesSetFormat(the_handle.the_value, 'A', the_ascii_word_type);
#endif
