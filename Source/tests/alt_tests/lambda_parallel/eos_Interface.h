...
#define EOS_NUM_TABLE_OPTIONS    20     /* Total number of public option flags */
...
#define EOS_MaxErrMsgLen                          512   /* The maximum length of an error message to be returned to the host code */
...
static const EOS_INTEGER EOS_INVALID_INFO_FLAG = 2038;  /* The info flag passed into eos_GetTableInfo() is invalid */
...
static const EOS_INTEGER EOS_MAX_ERROR_CODE_VALUE = 2048;       /* Maximum error code value */
