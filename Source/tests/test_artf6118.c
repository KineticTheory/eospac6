...
/*! \file
 *  \ingroup tests
 *  \brief Ensure free energy tables, which are associated with Sesame 411 and 412 tables
...
int main ()
{
  ...
  EOS_INTEGER tableType[nTablesE] =
    { /* cat 0 */
      EOS_Tm_D, EOS_Pm_D, EOS_Um_D, EOS_Am_D, EOS_Tf_D, EOS_Pf_D, EOS_Uf_D, EOS_Af_D,
      /* cat 1 */
      EOS_D_Tm, EOS_D_Pm, EOS_D_Um, EOS_D_Am, EOS_D_Tf, EOS_D_Pf, EOS_D_Uf, EOS_D_Af,
      /* cat 3 */
      EOS_Tm_Am, EOS_Pm_Am, EOS_Um_Am, EOS_Am_Tm, EOS_Am_Pm, EOS_Am_Um,
      EOS_Tf_Af, EOS_Pf_Af, EOS_Uf_Af, EOS_Af_Tf, EOS_Af_Pf, EOS_Af_Uf
    };
